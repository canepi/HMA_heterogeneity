...
create_sce_colonies(
  input.counts = "./2_results/colony/MV/TE_and_gene_counts_Updated_and_Raw.txt",
...
include_graphics('./figures/colony/MV/QC/Colony_QC1-libsizes.png')
```

#### Library size vs Features + Batch and % Mito

```{r, echo = params$echo.fig, out.width='95%', output.height="95%", fig.align='center', eval = params$eval.fig}
include_graphics('./figures/colony/MV/QC/Colony_QC1-scatter.png')
```

### Inidividual QC plots

```{r, echo = params$echo.fig, out.width='95%', output.height="95%", fig.align='center', eval = params$eval.fig}
include_graphics('./figures/colony/MV/QC/colony_QC1-combined.png')
```
...
```{r, echo = params$echo.fig, out.width='95%', output.height="95%", fig.align='center', eval = params$eval.fig}
include_graphics('./figures/colony/MV/QC/colony_QC1-PCA.png')
```
...
```{r, echo = params$echo.fig, out.width='95%', output.height="95%", fig.align='center', eval = params$eval.fig}
include_graphics('./figures/colony/MV/QC/colony_QC2-combined.png')
```
...
```{r, echo = params$echo.fig, out.width='95%', output.height="95%", fig.align='center', eval = params$eval.fig}
include_graphics('./figures/colony/MV/QC/colony_QC2-PCA-Genes_TEs_separate.png')
```
...
include_graphics('./figures/colony/MV/QC/colony_QC1.2-explanatoryvariables.png')
```
...
# MV colony methlyation levels {.tabset}
...
plot_MeanMeth(meta.data.tsv = "./2_results/colony/MV/cell_metadata.tsv",
              output.dir ="figures/colony/MV",
...
This identified four distinct cluster of genes: 
...
4. Down regulated in treated and methylation level independent (cluster 4)
...
Heatmap_by_treatment_group_corr_genes(sce.rds.file ="2_results/colony/MV/Batch_Correction/sce_qc2_norm_mnnCorrect_scMerged_2C.rds",
                                  correlated.gene.results = "./2_results/colony/MV/Correlated_Expression/Methylation_Exp_mnnCorrected_correlation.csv",
                                  padj.threshold = 0.05,
...
### Run 1
```{r, results=params$fig.results}
include_graphics('./figures/colony/MV/Correlated_Expression/Heatmap_DAC_Pos.Neg_0.4_mnnCorrected_Average_across_treatment_groups_MeanCentred_4Km_Run1.png')
```

### Run 2
```{r, results=params$fig.results}
include_graphics('./figures/colony/MV/Correlated_Expression/Heatmap_DAC_Pos.Neg_0.4_mnnCorrected_Average_across_treatment_groups_MeanCentred_4Km_Run2.png')
```

### Run 3
```{r, results=params$fig.results}
include_graphics('./figures/colony/MV/Correlated_Expression/Heatmap_DAC_Pos.Neg_0.4_mnnCorrected_Average_across_treatment_groups_MeanCentred_4Km_Run3.png')
```

### Run 4
```{r, results=params$fig.results}
include_graphics('./figures/colony/MV/Correlated_Expression/Heatmap_DAC_Pos.Neg_0.4_mnnCorrected_Average_across_treatment_groups_MeanCentred_4Km_Run4.png')
```

### Run 5
```{r, results=params$fig.results}
include_graphics('./figures/colony/MV/Correlated_Expression/Heatmap_DAC_Pos.Neg_0.4_mnnCorrected_Average_across_treatment_groups_MeanCentred_4Km_Run5.png')
```

## ORA GO - Not run {.tabset}
